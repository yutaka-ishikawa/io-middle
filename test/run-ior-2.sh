...
#
IOROPT1_1="-C -Q 1 -g -G 27 -k -e -O stoneWallingStatusFile=./result/ior-hard.stonewall_47008 -O stoneWallingWearOut=1 -t 47008 -b 47008 -s 2 -w -D 300 -a POSIX"
IOROPT2_1="-C -Q 1 -g -G 27 -k -e -O stoneWallingStatusFile=./result/ior-hard.stonewall_47008 -O stoneWallingWearOut=1 -t 47008 -b 47008 -s 2 -r -R -a POSIX"
...
mpiexec ${MPIOPT} ${IOR} ${IOROPT2_1} -o ${WORK}/${TEMP}/file
exit
